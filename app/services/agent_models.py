...
class AgentModelRegistry:
    ...
    def client_for(self, agent_name: str) -> AiClient:
        ...
        if profile.provider == "openai":
            ...
            settings.anthropic_model = profile.model
        else:
    ...
    def _default_model(self, provider: str) -> str:
        ...
        if provider == "anthropic":
            return getattr(self.settings, "anthropic_model", "deepseek-v4-pro")
        if provider == "ollama":
            return getattr(self.settings, "ollama_model", "psychelink-qwen2.5-7b-ft:latest")
        return "mock"
