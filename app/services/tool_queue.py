...
class ToolQueueWorker:
    ...
    def start(self) -> None:
        ...
        self.dispatcher = threading.Thread(target=self._loop, name="psychelink-tool-dispatcher", daemon=True)
