...
class Settings(BaseSettings):
    ...
    ollama_model: str = "psychelink-qwen2.5-7b-ft:latest"
    finetuned_model_name: str = "psychelink-qwen2.5-7b-ft:latest"
    finetuned_model_dir: str = "models/psychelink-qwen2.5-7b-ft"
    finetuned_model_file: str = "psychelink-qwen2.5-7b-ft-q4_k_m.gguf"
    ...
    database_url: str = "mysql+pymysql://psychelink:psychelink@127.0.0.1:3306/psychelink?charset=utf8mb4"
    ...
    alert_email_to: str = ""
    alert_email_subject_prefix: str = "[PsycheLink 高风险预警]"
