...
from app.services.skills import PsycheLinkSkillRegistry, SkillLoadError
...
class SkillRegistryTests(unittest.TestCase):
    def test_skill_registry_loads_valid_skill(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            skill = PsycheLinkSkillRegistry(root).get_required("demo_skill")
    ...
    def test_skill_status_reports_warnings(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            status = PsycheLinkSkillRegistry(root).status_items()[0]
    ...
    def test_skill_requires_frontmatter(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with self.assertRaises(SkillLoadError):
                PsycheLinkSkillRegistry(root).get_required("bad")
